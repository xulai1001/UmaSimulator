...
void main_testCardsSingle()
{
  ...
  for (int toTestCardType = 0; toTestCardType < 5; toTestCardType++)
  {
    if (toTestCardType == 0)
    {
        ...
        cards = { 302074,302084,302144,302324,302334,-1 };//友人，--，力西野花，根美妙，根防爆，智皇帝
    }
    ...
    else if (toTestCardType == 1)
    {
        //1速1耐1力1根1智
        umaId = 101101;//草上飞，20速10力加成
        cards = { 302074,302154,302084,302144,302334,-1 };//友人，速爱昔，--, 力西野花，根美妙，智皇帝
    }
    else if (toTestCardType == 2)
    {
        //1速1力2根1智
        umaId = 101101;//草上飞，20速10力加成
        cards = { 302074,302154,302144,302324,302334,-1 };//友人，速爱昔，--，根美妙，根防爆，智皇帝
    }
    ...
    else if (toTestCardType == 4)
    {
        //1速1力2根1智
        umaId = 101101;//草上飞，20速10力加成
        cards = { 302074,302154,302084,302144,302324,-1 };//友人，速爱昔，力西野花，根美妙，根防爆，--
    }
